...
FFLAGS_OPT = -O2 -debug minimal -fp-model precise -qoverride-limits -qopt-prefetch=3
FFLAGS_REPRO = -O2 -debug minimal -fp-model precise -qoverride-limits #-fpe0 #causes problems??
...
CFLAGS := -D__IFC -sox -msse2 -fp-model precise
ifeq ($(AVX2),Y)
